          ...
          <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-8 border ">
            ...
            <div className="mt-8">
              ...
              <Button
                ...
                className="w-full mt-4 bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 font-medium py-3 rounded-xl transition-all duration-200 text-sm sm:text-base flex items-center justify-center gap-2"
              >
                <img
