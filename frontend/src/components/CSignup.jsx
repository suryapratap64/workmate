              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  ...
                  <input
                    ...
                    maxLength="10"
                    required
                    className="flex-1 px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 text-gray-900 placeholder-gray-400"
                  />
                </div>
              </div>
            ...
            <form onSubmit={verifyOtpHandler} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  pattern="[0-9]{6}"
                  required
                  className="w-full px-4 py-3 text-center text-2xl font-mono border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 text-gray-900 placeholder-gray-400 tracking-widest"
                />
              </div>
